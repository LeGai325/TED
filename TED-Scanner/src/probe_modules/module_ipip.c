...
static int ipip_init_perthread(void *buf, macaddr_t *src,
...
static int ipip_make_packet(void *buf, size_t *buf_len,
...
static void ipip_print_packet(FILE *fp, void *packet)
{
...
static int ipip_validate_packet(const struct ip *ip_hdr, uint32_t len,
...
static void ipip_process_packet(const u_char *packet,
