/*
  ...
  gengetopt -C --no-help --no-version -i /home/gaile/zmap/src/zbopt.ggo -F /home/gaile/zmap/src/zbopt 
...
const char *gengetopt_args_info_help[] = {
  "Basic arguments:",
  "  -b, --blocklist-file=STRING   File of subnets to exclude, in CIDR notation,\n                                  one-per line.",
  "  -w, --allowlist-file=STRING   File of subnets to include, in CIDR notation,\n                                  one-per line.",
  ...
  "      --ignore-blocklist-errors Ignore invalid entries in the\n                                  blocklist/allowlist (default false)",
  "      --ignore-input-errors     Don't print invalid entries in the input\n                                  (default false)",
  "      --disable-syslog          Disables logging messages to syslog",
  "\nAdditional options:",
  "  -h, --help                    Print help and exit",
  "  -V, --version                 Print version and exit",
  "At least one of --allowlist-file or --blocklist-file must be specified.\nBlacklist files take precedence over allowlist files when both are specified.\nThis results in an output of {allowlist - blocklist}.",
    0
};
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->blocklist_file_help = gengetopt_args_info_help[1] ;
  args_info->allowlist_file_help = gengetopt_args_info_help[2] ;
  ...
  args_info->ignore_blocklist_errors_help = gengetopt_args_info_help[6] ;
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          /* Ignore invalid entries in the blocklist/allowlist (default false).  */
          ...
          /* Don't print invalid entries in the input (default false).  */
