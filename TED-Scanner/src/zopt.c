/*
  ...
  gengetopt -C --no-help --no-version --unamed-opts=SUBNETS -i /home/gaile/zmap/src/zopt.ggo -F /home/gaile/zmap/src/zopt 
...
#include "/home/gaile/zmap/src/zopt.h"
...
const char *gengetopt_args_info_help[] = {
  ...
  "\nIPv6:",
  "      --ipv6-target-file=filename\n                                File containing IPv6 addresses to be scanned,\n                                  use '-' for stdin",
  "      --ipv6-source-ip=name     Source IPv6 address for scan packets",
  "\nTunnelling Modules:",
  "      --spoofing-address-v4=name\n                                Spoofing IPv4 address for spoofing probe\n                                  modules",
  "      --spoofing-address-v6=name\n                                Spoofing IPv6 address for spoofing probe\n                                  modules",
  "      --external-ipv4-address=name\n                                Used for probe modules where the packet needs\n                                  to be forwarded to the global ip address",
  "      --external-ipv6-address=name\n                                Used for probe modules where the packet needs\n                                  to be forwarded to the global ipv6 address",
  "\nResults Output:",
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->ipv6_target_file_given = 0 ;
  args_info->ipv6_source_ip_given = 0 ;
  args_info->spoofing_address_v4_given = 0 ;
  args_info->spoofing_address_v6_given = 0 ;
  args_info->external_ipv4_address_given = 0 ;
  args_info->external_ipv6_address_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->ipv6_target_file_arg = NULL;
  args_info->ipv6_target_file_orig = NULL;
  args_info->ipv6_source_ip_arg = NULL;
  args_info->ipv6_source_ip_orig = NULL;
  args_info->spoofing_address_v4_arg = NULL;
  args_info->spoofing_address_v4_orig = NULL;
  args_info->spoofing_address_v6_arg = NULL;
  args_info->spoofing_address_v6_orig = NULL;
  args_info->external_ipv4_address_arg = NULL;
  args_info->external_ipv4_address_orig = NULL;
  args_info->external_ipv6_address_arg = NULL;
  args_info->external_ipv6_address_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->ipv6_target_file_help = gengetopt_args_info_help[34] ;
  args_info->ipv6_source_ip_help = gengetopt_args_info_help[35] ;
  args_info->spoofing_address_v4_help = gengetopt_args_info_help[37] ;
  args_info->spoofing_address_v6_help = gengetopt_args_info_help[38] ;
  args_info->external_ipv4_address_help = gengetopt_args_info_help[39] ;
  args_info->external_ipv6_address_help = gengetopt_args_info_help[40] ;
  args_info->output_fields_help = gengetopt_args_info_help[42] ;
  args_info->output_module_help = gengetopt_args_info_help[43] ;
  args_info->output_args_help = gengetopt_args_info_help[44] ;
  args_info->output_filter_help = gengetopt_args_info_help[45] ;
  args_info->list_output_modules_help = gengetopt_args_info_help[46] ;
  args_info->list_output_fields_help = gengetopt_args_info_help[47] ;
  args_info->no_header_row_help = gengetopt_args_info_help[48] ;
  args_info->verbosity_help = gengetopt_args_info_help[50] ;
  args_info->log_file_help = gengetopt_args_info_help[51] ;
  args_info->log_directory_help = gengetopt_args_info_help[52] ;
  args_info->metadata_file_help = gengetopt_args_info_help[53] ;
  args_info->status_updates_file_help = gengetopt_args_info_help[54] ;
  args_info->quiet_help = gengetopt_args_info_help[55] ;
  args_info->disable_syslog_help = gengetopt_args_info_help[56] ;
  args_info->notes_help = gengetopt_args_info_help[57] ;
  args_info->user_metadata_help = gengetopt_args_info_help[58] ;
  args_info->config_help = gengetopt_args_info_help[60] ;
  args_info->max_sendto_failures_help = gengetopt_args_info_help[61] ;
  args_info->min_hitrate_help = gengetopt_args_info_help[62] ;
  args_info->sender_threads_help = gengetopt_args_info_help[63] ;
  args_info->cores_help = gengetopt_args_info_help[64] ;
  args_info->ignore_blocklist_errors_help = gengetopt_args_info_help[65] ;
  args_info->help_help = gengetopt_args_info_help[66] ;
  args_info->version_help = gengetopt_args_info_help[67] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->ipv6_target_file_arg));
  free_string_field (&(args_info->ipv6_target_file_orig));
  free_string_field (&(args_info->ipv6_source_ip_arg));
  free_string_field (&(args_info->ipv6_source_ip_orig));
  free_string_field (&(args_info->spoofing_address_v4_arg));
  free_string_field (&(args_info->spoofing_address_v4_orig));
  free_string_field (&(args_info->spoofing_address_v6_arg));
  free_string_field (&(args_info->spoofing_address_v6_orig));
  free_string_field (&(args_info->external_ipv4_address_arg));
  free_string_field (&(args_info->external_ipv4_address_orig));
  free_string_field (&(args_info->external_ipv6_address_arg));
  free_string_field (&(args_info->external_ipv6_address_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->ipv6_target_file_given)
    write_into_file(outfile, "ipv6-target-file", args_info->ipv6_target_file_orig, 0);
  if (args_info->ipv6_source_ip_given)
    write_into_file(outfile, "ipv6-source-ip", args_info->ipv6_source_ip_orig, 0);
  if (args_info->spoofing_address_v4_given)
    write_into_file(outfile, "spoofing-address-v4", args_info->spoofing_address_v4_orig, 0);
  if (args_info->spoofing_address_v6_given)
    write_into_file(outfile, "spoofing-address-v6", args_info->spoofing_address_v6_orig, 0);
  if (args_info->external_ipv4_address_given)
    write_into_file(outfile, "external-ipv4-address", args_info->external_ipv4_address_orig, 0);
  if (args_info->external_ipv6_address_given)
    write_into_file(outfile, "external-ipv6-address", args_info->external_ipv6_address_orig, 0);
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        ...
        { "ipv6-target-file",	1, NULL, 0 },
        { "ipv6-source-ip",	1, NULL, 0 },
        { "spoofing-address-v4",	1, NULL, 0 },
        { "spoofing-address-v6",	1, NULL, 0 },
        { "external-ipv4-address",	1, NULL, 0 },
        { "external-ipv6-address",	1, NULL, 0 },
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          /* File containing IPv6 addresses to be scanned, use '-' for stdin.  */
          else if (strcmp (long_options[option_index].name, "ipv6-target-file") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->ipv6_target_file_arg), 
                 &(args_info->ipv6_target_file_orig), &(args_info->ipv6_target_file_given),
                &(local_args_info.ipv6_target_file_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "ipv6-target-file", '-',
                additional_error))
              goto failure;
          ...
          /* Source IPv6 address for scan packets.  */
          else if (strcmp (long_options[option_index].name, "ipv6-source-ip") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->ipv6_source_ip_arg), 
                 &(args_info->ipv6_source_ip_orig), &(args_info->ipv6_source_ip_given),
                &(local_args_info.ipv6_source_ip_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "ipv6-source-ip", '-',
                additional_error))
              goto failure;
          ...
          /* Spoofing IPv4 address for spoofing probe modules.  */
          else if (strcmp (long_options[option_index].name, "spoofing-address-v4") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->spoofing_address_v4_arg), 
                 &(args_info->spoofing_address_v4_orig), &(args_info->spoofing_address_v4_given),
                &(local_args_info.spoofing_address_v4_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "spoofing-address-v4", '-',
                additional_error))
              goto failure;
          ...
          /* Spoofing IPv6 address for spoofing probe modules.  */
          else if (strcmp (long_options[option_index].name, "spoofing-address-v6") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->spoofing_address_v6_arg), 
                 &(args_info->spoofing_address_v6_orig), &(args_info->spoofing_address_v6_given),
                &(local_args_info.spoofing_address_v6_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "spoofing-address-v6", '-',
                additional_error))
              goto failure;
          ...
          /* Used for probe modules where the packet needs to be forwarded to the global ip address.  */
          else if (strcmp (long_options[option_index].name, "external-ipv4-address") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->external_ipv4_address_arg), 
                 &(args_info->external_ipv4_address_orig), &(args_info->external_ipv4_address_given),
                &(local_args_info.external_ipv4_address_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
          ...
          /* Used for probe modules where the packet needs to be forwarded to the global ipv6 address.  */
          else if (strcmp (long_options[option_index].name, "external-ipv6-address") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->external_ipv6_address_arg), 
                 &(args_info->external_ipv6_address_orig), &(args_info->external_ipv6_address_given),
                &(local_args_info.external_ipv6_address_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
