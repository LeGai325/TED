...
struct gengetopt_args_info
{
  ...
  int batch_arg;	/**< @brief Set the number of packets to send per iteration.  */
  char * batch_orig;	/**< @brief Set the number of packets to send per iteration original value given at command line.  */
  const char *batch_help; /**< @brief Set the number of packets to send per iteration help description.  */
  ...
  char * ipv6_target_file_arg;	/**< @brief File containing IPv6 addresses to be scanned, use '-' for stdin.  */
  char * ipv6_target_file_orig;	/**< @brief File containing IPv6 addresses to be scanned, use '-' for stdin original value given at command line.  */
  const char *ipv6_target_file_help; /**< @brief File containing IPv6 addresses to be scanned, use '-' for stdin help description.  */
  char * ipv6_source_ip_arg;	/**< @brief Source IPv6 address for scan packets.  */
  char * ipv6_source_ip_orig;	/**< @brief Source IPv6 address for scan packets original value given at command line.  */
  const char *ipv6_source_ip_help; /**< @brief Source IPv6 address for scan packets help description.  */
  char * spoofing_address_v4_arg;	/**< @brief Spoofing IPv4 address for spoofing probe modules.  */
  char * spoofing_address_v4_orig;	/**< @brief Spoofing IPv4 address for spoofing probe modules original value given at command line.  */
  const char *spoofing_address_v4_help; /**< @brief Spoofing IPv4 address for spoofing probe modules help description.  */
  char * spoofing_address_v6_arg;	/**< @brief Spoofing IPv6 address for spoofing probe modules.  */
  char * spoofing_address_v6_orig;	/**< @brief Spoofing IPv6 address for spoofing probe modules original value given at command line.  */
  const char *spoofing_address_v6_help; /**< @brief Spoofing IPv6 address for spoofing probe modules help description.  */
  char * external_ipv4_address_arg;	/**< @brief Used for probe modules where the packet needs to be forwarded to the global ip address.  */
  char * external_ipv4_address_orig;	/**< @brief Used for probe modules where the packet needs to be forwarded to the global ip address original value given at command line.  */
  const char *external_ipv4_address_help; /**< @brief Used for probe modules where the packet needs to be forwarded to the global ip address help description.  */
  char * external_ipv6_address_arg;	/**< @brief Used for probe modules where the packet needs to be forwarded to the global ipv6 address.  */
  char * external_ipv6_address_orig;	/**< @brief Used for probe modules where the packet needs to be forwarded to the global ipv6 address original value given at command line.  */
  const char *external_ipv6_address_help; /**< @brief Used for probe modules where the packet needs to be forwarded to the global ipv6 address help description.  */
  ...
  unsigned int ipv6_target_file_given ;	/**< @brief Whether ipv6-target-file was given.  */
  unsigned int ipv6_source_ip_given ;	/**< @brief Whether ipv6-source-ip was given.  */
  unsigned int spoofing_address_v4_given ;	/**< @brief Whether spoofing-address-v4 was given.  */
  unsigned int spoofing_address_v6_given ;	/**< @brief Whether spoofing-address-v6 was given.  */
  unsigned int external_ipv4_address_given ;	/**< @brief Whether external-ipv4-address was given.  */
  unsigned int external_ipv6_address_given ;	/**< @brief Whether external-ipv6-address was given.  */
