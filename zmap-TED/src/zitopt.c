/*
  ...
  gengetopt -C --no-help --no-version --unamed-opts=SUBNETS -i /home/gaile/zmap/src/zitopt.ggo -F /home/gaile/zmap/src/zitopt 
...
#include "/home/gaile/zmap/src/zitopt.h"

const char *gengetopt_args_info_purpose = "A tool for iterating over the IPv4 space";

const char *gengetopt_args_info_usage = "Usage: ziterate [OPTIONS]... [SUBNETS]...";
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->ignore_blocklist_errors_help = gengetopt_args_info_help[5] ;
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "ignore-blocklist-errors") == 0)
          {
